...
PILLAR_GUIDANCE = (
    ...
    "Suggest by meaning only of the butterfly effect, and how it could improve our lives by doing something small will gradually create something great and truly meaningul.\n"
